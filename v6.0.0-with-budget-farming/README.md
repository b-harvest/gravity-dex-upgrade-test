...
- Upgrade test version: [Forked Gaia that includes budget and farming](https://github.com/b-harvest/gravity-dex/tree/add-budget-and-farming-on-vega)
...
```bash
# Use git to clone the project and build it
git clone -b add-budget-and-farming-on-vega https://github.com/b-harvest/gravity-dex.git
cd gravity-dex
make install
```
...
> 
615a5c66ed3d721fe16802b3032918320945e6a4fbd975570e8ea5db206fa878
```
...
if [ $platform = 'linux' ]; then
  sed -i 's%"chain_id": "cosmoshub-4",%"chain_id": "cosmoshub-4-upgrade-testnet-2003",%g' genesis.json
...
#####################################################################
# DO NOT PROCEED BELOW COMMANDS. 
# IT'S JUST AN EXPLANATION ABOUT WHAT WE CHANGED WITH 'sed' COMMAND
#####################################################################

# Change chain_id
sed -i $SED_I 's%"chain_id": "cosmoshub-4",%"chain_id": "cosmoshub-4-upgrade-testnet-2003",%g' genesis.json
...
export CHAIN_ID=cosmoshub-4-upgrade-testnet-2003
...
--upgrade-info "add-budget-and-farming-on-vega-xxxxxxxxxxxxxx" \
...
```json
{
  ...
  "content": {
    ...
    "plan": {
      ...
      "height": "7304530",
      "info": "add-budget-and-farming-on-vega-xxxxxxxxxxxxxx",
  ...
  "submit_time": "2021-10-25T12:57:49.938185Z",
  "deposit_end_time": "2021-11-08T12:57:49.938185Z",
  "total_deposit": [
    {
      "denom": "uatom",
      "amount": "1000"
  ...
  "voting_start_time": "2021-10-25T12:57:49.938185Z",
  "voting_end_time": "2021-10-25T12:58:49.938185Z"
}
```
...
> ERR UPGRADE "Vega" NEEDED at height: 7304530: add-budget-and-farming-on-vega-xxxxxxxxxxxxxx
> ERR CONSENSUS FAILURE!!! err="UPGRADE \"Vega\" NEEDED at height: 7304530: add-budget-and-farming-on-vega-xxxxxxxxxxxxxx" module=consensus stack="goroutine 167 [running]:\nruntime/debug.Stack()\n\truntime/debug/stack.go:24 +0x65\ngithub.com/tendermint/tendermint/consensus.(*State)...
...
+++ genesis.json        2021-10-25 21:48:37.000000000 +0900
@@ -1,6 +1,6 @@
 {
   "genesis_time": "2019-12-11T16:11:34Z",
-  "chain_id": "cosmoshub-4",
+  "chain_id": "cosmoshub-4-upgrade-testnet-2003",
